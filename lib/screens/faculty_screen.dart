...
class _FacultyScreenState extends State<FacultyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          builder: (context, snapshot) {
            ...
            return DataTable2(
              ...
              columns: const [
                ...
                DataColumn2(label: Text('Assigned Courses'), size: ColumnSize.S),
                DataColumn2(label: Text('Actions'), size: ColumnSize.S),
              ],
              rows: users.map((user) => DataRow(
                onSelectChanged: (_) => _showFacultyDetails(context, user),
                cells: [
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => _showFacultyDialog(context, null),
        child: const Icon(Icons.add),
      ),
    );
  }

  void _showFacultyDetails(BuildContext context, UserModel user) {
    showDialog(
      context: context,
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            ...
                            _DetailItem(label: 'Date of Joining', value: user.dateOfAdmission != null ? user.dateOfAdmission.toString().split(' ')[0] : 'N/A'),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          children: [
                             ...
                             _DetailItem(label: 'Assigned Courses', value: enrolledParams.isEmpty ? 'None' : enrolledParams),
                          ],
                        ),
                      ),
                    ],
  ...
  void _showFacultyDialog(BuildContext context, UserModel? user) {
                ...
                child: StreamBuilder<List<CourseModel>>(
                  ...
                  builder: (context, snapshot) {
                     ...
                     return Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(user == null ? 'Add Faculty Details' : 'Edit Faculty Details', 
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Course Assignment', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                                  const SizedBox(height: 16),
                                  Container(
